...
@Slf4j
public class Excel {
    public static <T> List<T> readExcel(String path, Class<T> clazz, String sheetName) throws IOException {
    ...
    public static <T> boolean writeExcel(String path, List<T> dataList, String sheetName) {
