...
cd /home/ubuntu/source-code
git clone https://github.com/leeqiang250/billion.git ${app_name}
cd ${app_name}
...
cp /home/ubuntu/source-code/billion/shell/${app_name}/${app_name}.sh /home/ubuntu/${app_name}/restart.sh
